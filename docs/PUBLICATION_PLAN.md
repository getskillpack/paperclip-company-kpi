...
- Источник копирайта: [LANDING.md](./LANDING.md).
- Варианты размещения: GitHub Pages из `/docs`, отдельная страница на сайте skpkg (если появится), или редирект с `homepage` в npm на README — выбор board/CMO.
- Минимальный MVP лендинга: один экран — проблема, решение, установка, ссылка на репозиторий.
